...
export default function BlogCard({
  ...
  return (
    <div className="container mx-auto px-6 md:px-0 border-t border-dark20 py-14 lg:py-20 grid grid-cols-3 md:grid-cols-5 gap-y-4">
      {/* Author Section */}
      <AuthorInfo
        avatarAlt={avatarAlt}
        avatarSrc={avatarSrc}
      ...
      <div className="hidden md:block md:col-span-2 lg:col-span-1">
        <button className="flex items-center gap-1 text-grey60 border border-dark20 w-full justify-center md:px-5 py-3 rounded-xl text-sm">
          View All Blogs
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
