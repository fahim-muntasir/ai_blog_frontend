    ...
    <section>
      ...
      <div className="border-b border-dark20 ">
        <div className="container mx-auto px-6 md:px-0 md:flex md:gap-8">
          <div className=" py-16 border-b md:border-b-0 md:border-r md:pr-8 border-dark20 ">
            <div className="flex gap-5 justify-center mb-10">
              ...
              <div>
                ...
                <span className="text-dark40 lg:text-lg">
                  San Francisco, USA
                </span>
              </div>
            </div>

            <div className="bg-dark10 border border-dark20 rounded-2xl relative text-center p-10">
              <div className=" absolute top-0 left-1/2 transform -translate-x-1/2  flex justify-center items-center text-[#FFCE22] bg-dark8 w-[140px] h-[36px] mt-[-18px] border border-dark20 rounded-full">
                <svg
